...
Execution times are measured using the `time` command on the bash command line. The overhead of [Visual Studio Code (VS Code)](https://code.visualstudio.com) and [Markdown Preview Enhanced (MPE)](https://shd101wyy.github.io/markdown-preview-enhanced/) are not included.
